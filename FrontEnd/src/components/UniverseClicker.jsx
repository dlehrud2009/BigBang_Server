...
const PLANETS = [
  ...
  },
  {
    id: "saturn",
    name: "토성",
    description: "에너지 생성 속도 60% 증가",
    baseCost: 75000,
    effect: "autoBonus", // 자동 생성 속도 증가
    multiplier: 1.6,
    emoji: "♄",
    color: "#FAD5A5",
  },
...
const COSMOS = [
  ...
  { id: "virgo", name: "처녀자리 은하단", description: "에너지 생성 속도 50% 증가", baseCost: 1.5e93, effect: "autoBonus", multiplier: 1.5, emoji: "🌠", color: "#ffd08a" },
  ...
  { id: "pulsar", name: "펄사", description: "에너지 생성 속도 60% 증가", baseCost: 1.6e93, effect: "autoBonus", multiplier: 1.6, emoji: "🧭", color: "#a0e7ff" },
  ...
  { id: "starcluster", name: "산개성단", description: "에너지 생성 속도 60% 증가", baseCost: 1.3e93, effect: "autoBonus", multiplier: 1.6, emoji: "🌟", color: "#ffd7a0" },
  ...
  { id: "megamaser", name: "메가메이저", description: "에너지 생성 속도 75% 증가", baseCost: 2.1e93, effect: "autoBonus", multiplier: 1.75, emoji: "📡", color: "#b0e0ff" },
